...
class PowerManagementHandler(FeatureHandler):
    ...
    009.37 / 009.42 / 009.45: Extended to surface even more labeled fields (extra_setting_3, extra_setting_4, extra_setting_5, extra_setting_6, extra_setting_7, extra_setting_8, extra_setting_9, extra_setting_10, etc.) when the listener provides them.
    """
